...
export type GameMode =
  | 'quick' | 'battle-royale' | 'multiplayer'
  | 'lone-wolf' | 'training' | 'tdm'
  | 'zombie' | 'gun-game' | 'diamond-race'
  | 'king-hill' | 'capture-flag';
...
export const VEHICLES: VehicleDef[] = [
  {
    id: 'sport-car', name: 'Buggy Sport', icon: '🚗',
    price: 500, currency: 'gold', speed: 14, health: 200, color: '#cc2200',
    description: 'Rapide et maniable — parfait pour fuir la zone',
  },
  {
    id: 'moto', name: 'Moto', icon: '🏍️',
    price: 300, currency: 'gold', speed: 18, health: 100, color: '#222222',
    description: 'Ultra rapide, peu résistante — sens aigu du danger',
  },
  {
    id: 'monster', name: 'Monster Truck', icon: '🚛',
    price: 80, currency: 'diamonds', speed: 8, health: 500, color: '#226622',
    description: 'Lent mais dévastateur — écrase tout sur son passage',
  },
];
...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    skillDesc: 'Régénère 5 HP/s en permanence.',
    speedBonus: 1.0, hpBonus: 0, dmgBonus: 1, healRegen: true,
  },
  {
    id: 7, name: 'Andrew', gender: 'boy', color: '#cc2222', helmetColor: '#881111',
    bonus: '-15% dégâts', skillName: 'Bouclier', skillType: 'passive',
  ...
  },
  {
    ...
    animeStyle: 'Goku', auraColor: '#ffcc00',
  },
];
...
export const MODES: { id: GameMode; name: string; icon: string; description: string; enemyCount: number; color: string }[] = [
  { id:'quick',        name:'Partie Rapide',   icon:'⚡', description:'5-14 bots. Élimine-les tous.', enemyCount:5,  color:'#2255cc' },
  { id:'battle-royale',name:'Battle Royale',   icon:'🏆', description:'20 bots, zone rétrécissante. Phase avion incluse.', enemyCount:20, color:'#ff6600' },
  { id:'multiplayer',  name:'Multijoueur',     icon:'👥', description:'8 ennemis + allié IA à tes côtés.', enemyCount:8, color:'#00aa88' },
  { id:'lone-wolf',    name:'Loup Solitaire',  icon:'🐺', description:'1v1 intense. Meilleur des 5 manches.', enemyCount:1, color:'#ff2244' },
  { id:'training',     name:'Entraînement',    icon:'🎯', description:'Mannequins infinis. Munitions illimitées.', enemyCount:5, color:'#44cc88' },
  { id:'tdm',          name:'Match à Mort',    icon:'⚔️', description:'Ton équipe vs la leur. 12 bots.', enemyCount:12, color:'#cc4422' },
  { id:'zombie',       name:'Mode Zombie',     icon:'🧟', description:'Survie face aux hordes de zombies.', enemyCount:15, color:'#226622' },
  { id:'gun-game',     name:'Gun Game',        icon:'🔫', description:'Change d\'arme à chaque kill.', enemyCount:8, color:'#aa6600' },
  { id:'diamond-race', name:'Course Diamants', icon:'💎', description:'Ramasse le plus de diamants au sol.', enemyCount:6, color:'#aa44ff' },
  { id:'king-hill',    name:'Roi de la Colline',icon:'👑', description:'Tiens la zone centrale 60 secondes.', enemyCount:10, color:'#ddaa00' },
  { id:'capture-flag', name:'Capture Drapeau', icon:'🚩', description:'Capture le drapeau ennemi et ramène-le.', enemyCount:8, color:'#2288cc' },
];
